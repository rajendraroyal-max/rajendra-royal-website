...
/* ── ADMIN PANEL ─────────────────────────────────────────────── */
const TABS = ["Profile", "About", "Expertise", "Curriculum", "Credentials", "Portfolio", "Speaking", "Journey", "Quotes", "Testimonials", "Blog", "Ticker"];
    ...
    <>
      ...
      <nav>
        ...
        <ul className="nav-links">
          {[["#about","About"],["#expertise","Expertise"],["#portfolio","Portfolio"],["#journey","Journey"],["#quotes","Perspective"],["#testimonials","Testimonials"],["#blog","Insights"],["#contact","Contact"]].map(([h,l]) => (
      ...
      <section style={{ background: G.bg, padding: "76px 5%" }} id="testimonials">
        <FadeIn>
          ...
          <div style={{ marginTop: "1.4rem", padding: "1rem 1.3rem", border: `1px dashed ${G.borderGold}`, background: G.goldBg, display: "flex", alignItems: "center", gap: "1rem" }}>
            ...
            <a href={`https://${data.profile.linkedin}`} target="_blank" style={{ marginLeft: "auto", flexShrink: 0, padding: ".38rem .9rem", border: `1px solid ${G.borderGold}`, color: G.gold, fontSize: ".7rem", fontWeight: 600, letterSpacing: ".08em", textTransform: "uppercase", textDecoration: "none", transition: "all .22s", whiteSpace: "nowrap" }}
        ...
        <FadeIn>
          ...
          <div className="contact-grid">
            <div>
              ...
              <a href={`https://${data.profile.linkedin}`} target="_blank" className="soc-link"><div className="soc-icon"><LinkedInIcon /></div><div><div className="soc-name">LinkedIn</div><div className="soc-handle">{data.profile.linkedin}</div></div></a>
              ...
              <a href={`https://twitter.com/${data.profile.twitter}`} target="_blank" className="soc-link"><div className="soc-icon"><TwitterIcon /></div><div><div className="soc-name">X (Twitter)</div><div className="soc-handle">{data.profile.twitter}</div></div></a>
            </div>
            <div>
              <div className="f-row">
